...
Public Class rptPresupuestoGva
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dll_gva.rptPresupuestoGva.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPresupuestoGva
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPresupuestoGva = New rptPresupuestoGva()
        rpt.Site = Me.Site
        Return rpt
    End Function
