...
Public Class rptManoObra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "dll_CostoManoObraDirecta.rptManoObra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptManoObra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptManoObra = New rptManoObra()
        rpt.Site = Me.Site
        Return rpt
    End Function
